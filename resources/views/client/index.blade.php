        ...
        <div class="box box-black">
            <div class="box-header with-border">
                <div class="col-xs-12 col-sm-6 col-lg-4">
                    <a href="{{ route('clientes.create') }}" title="Cadastrar Usuário">                           
                            ...
                            <tbody>
                                @foreach($clients as $client)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('clientes.show', ['id' => $client->id]) }}" type="button" class="btn btn-primary btn-flat" title="Visualizar Usuário"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('clientes.edit', ['id' => $client->id]) }}" type="button" class="btn btn-warning btn-flat" title="Editar Usuário"><i class="fa fa-pencil-alt"></i></a>
                                                <a href="#" onclick="confirmarExclusao({{ $client->id }}, '{{ $client->name }}')" data-toggle="modal" data-target="#modal-exclusao" class="btn btn-danger btn-flat" title="Excluir Usuário">
